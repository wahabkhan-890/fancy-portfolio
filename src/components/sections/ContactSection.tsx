      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-4 pt-4">
          <Link
            ...
            className="text-sm sm:text-md 2xl:text-lg px-4 sm:px-6 py-3 rounded-xl bg-violet-500 text-white font-medium shadow-[0_0_40px_rgba(139,92,246,0.45)] hover:shadow-[0_0_70px_rgba(139,92,246,0.7)] transition"
          >
            Send a Message
          </Link>
          ...
          <a
            ...
            className="text-sm sm:text-md 2xl:text-lg px-4 sm:px-6 py-3 rounded-xl border border-violet-500/40 text-violet-500 dark:text-violet-400 hover:bg-violet-500/10 transition"
          >
            Email Me
          </a>
        </div>
