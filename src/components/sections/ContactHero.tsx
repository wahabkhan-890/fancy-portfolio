    ...
    <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-4 pt-4">
          <Link href="#contact-section" className="text-sm sm:text-md 2xl:text-lg px-4 sm:px-6 py-3 rounded-xl bg-primary text-white font-medium shadow-[0_0_40px_rgba(var(--primary-rgb),0.45)] hover:shadow-[0_0_70px_rgba(var(--primary-rgb),0.7)] transition">
            Send a Message
          </Link>
          <a href="mailto:wahabkhan9605@gmail.com" className="text-sm sm:text-md 2xl:text-lg px-4 sm:px-6 py-3 rounded-xl border border-primary/40 text-primary dark:text-primary-light hover:bg-primary/10 transition">
            Email Me
          </a>
        </div>
      </div>
